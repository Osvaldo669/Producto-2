            ...
            <form>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <asp:DropDownList ID="Tipos_usb_drop" runat="server" Width="100%" CssClass="btn btn-secondary dropdown-toggle"></asp:DropDownList>
                    </div>
                </div>
                <br />
                <div class="form-row">
                ...
                <br />
                <asp:Button ID="Guardar" OnClick="Guardar_Click" runat="server" CssClass=" btn btn-success" Text="Guardar Mouse" />
            </form>
            </div>
              </div>
        </div>
