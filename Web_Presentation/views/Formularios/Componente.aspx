...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="margin-top: 3%">
        <div class="card alert alert-dark">
            <h5 class="card-header">Insertar un componente</h5>
            <div class="card-body">
                    ...
                    <form>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <asp:TextBox ID="Componente_textB" CssClass="form-control" runat="server" placeholder="Componente" Width="100%"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <asp:Label ID="Label3" runat="server" Text="Extra"></asp:Label>
                            <asp:TextBox ID="Extra" CssClass="form-control" runat="server" placeholder="Extra--No es necesario llenarlo " Width="100%"></asp:TextBox>
                        </div>
                        <br />
                            <div class="form-row">
                        ...
                        <div class="form-row" runat="server">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="row" style="margin-top:3%">
                                    <asp:Button ID="Button1" CssClass="btn btn-warning" OnClick="guardar_datos_Click" runat="server" Text="Actualizar Datos" />
                                </div>
