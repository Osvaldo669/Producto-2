              ...
              <h4><asp:Label ID="Especial" runat="server" Text=""> </asp:Label></h4>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <asp:TextBox ID="tipo_ram" CssClass="form-control" runat="server" placeholder="Tipo" Width="100%"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <asp:Label ID="Label3" runat="server" Text="Extra"></asp:Label>
                            <asp:TextBox ID="extra_TB" CssClass="form-control" runat="server" placeholder="Extra--No es necesario llenarlo" Width="100%"></asp:TextBox>
                        </div>
                        <br />
                            <div class="form-row">
